...
import com.realityexpander.tasky.core.presentation.notifications.RemindAtNotificationManager.ALARM_NOTIFICATION_INTENT_ACTION_COMPLETE_TASK
...
class CompleteTaskBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        val agendaItemId = intent.getStringExtra(RemindAtNotificationManager.ALARM_NOTIFICATION_INTENT_EXTRA_AGENDA_ID) as? UuidStr
        agendaItemId ?: return
